...
public class Swap {
    public static void main(String args[]) {
        ...
        // Known as XOR trick
        System.out.println("practice.swap.Swap two integers without third variable using XOR bitwise Operator");
        int x = 30;
        int y = 60;
...
//    practice.swap.Swap two integers without third variable using XOR bitwise Operator
